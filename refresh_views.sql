...
CREATE INDEX dpnk_gpxfile_anonymized_2016_idx ON dpnk_gpxfile_anonymized_2016 USING GIST (the_geom);
...
CREATE INDEX dpnk_track_anonymized_2016_idx ON dpnk_track_anonymized_2016 USING GIST (the_geom);
