    ...
    def test_batch_csv(self):
        ...
        with open(temp_file.name) as temp_file:
            ...
            self.assertEquals(
                ...
                "foo@email.cz;123456789;;;;;;1603824;0.5;0.125;1;č. krab. 1603824 Nezastihnete-li opakovaně adresáta, doručte balík na adresu níže.;;",
                csv_string_lines[1],
            )
    ...
    def test_batch_csv_addressee(self):
        ...
        with open(temp_file.name) as temp_file:
            ...
            self.assertEquals(
                ...
                "addressee@email.cz;987654321;;;;;;1603824;0.5;0.125;1;č. krab. 1603824 Nezastihnete-li opakovaně adresáta, doručte balík na adresu níže.;;",
                csv_string_lines[1],
            )
        os.system("rm %s" % temp_file.name)
