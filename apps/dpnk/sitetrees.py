...
sitetrees = (
            ...
            item(
                ...
                children=[
                    item(
                        "Změnit společnost",
                        "zmenit_tym",
                        title_en="Change Company",
                        title_dsnkcs="Změnit školu",
                    ),
                    item("Aplikace", "application", title_en="Applications"),
                ],
            ),
            ...
            item(
                ...
                children=[
                    item(
                        "O AutoMatu",
                        "https://www.auto-mat.cz/",
                        title_en="About AutoMat",
                        url_as_pattern=False,
                    ),
                    item(
                        "Podpořte AutoMat",
                        "https://www.nakrmteautomat.cz/",
                        title_en="Support AutoMat",
                        url_as_pattern=False,
                    ),
                    item(
                        "Svobodný Software",
                        "https://github.com/auto-mat/do-prace-na-kole",
                        title_en="Free Software",
                        url_as_pattern=False,
                    ),
                ],
            ),
    ...
    tree(
        "company_coordinator_menu",
        "Menu firemního koordinátora",
        items=[
            item(
                "Firemní koordinátor",
                None,
                title_en="Company Coordinator",
                title_dsnkcs="Školní koordinátor",
                children=[
                    ...
                    item(
                        ...
                        title_dsnkcs="Adresa školy",
                    ),
                    item(
                        "Startovné",
                        "company_admin_pay_for_users",
                        title_en="Participant Fee",
                    ),
                    ...
                    item(
                        ...
                        title_en="Company Competitions",
                        title_dsnkcs="Školní soutěže",
                    ),
                    item(
                        "Vypsat soutěž",
                        "company_admin_competition",
                        title_en="Enroll Competition",
                    ),
                ],
            ),
        ],
