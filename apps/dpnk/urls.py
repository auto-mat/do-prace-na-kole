...
urlpatterns = patterns('',
    ...
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/profil/$',
        profile),
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/dalsi_clenove/$',
        other_team_members),
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/jizdy/$',
        rides),
    ...
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/prihlasky/$',
        admissions,
    ...
    url(r'^vysledky_souteze/(?P<competition_slug>[0-9A-Za-z_\-]+)/(?P<limit>[0-9]+)/$',
        competition_results,
        {'template': 'registration/competition_results.html'}),
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/otazka/(?P<questionaire_slug>[0-9A-Za-z_\-]+)/$',
        questionaire),
    ...
    url(r'^(?P<campaign_slug>[0-9A-Za-z_\-]+)/statistika/(?P<variable>[0-9A-Za-z\-]+)/$',
        statistics),
    url(r'^denni-graf/$',
        daily_chart),
    url(r'^facebook_app/$',
