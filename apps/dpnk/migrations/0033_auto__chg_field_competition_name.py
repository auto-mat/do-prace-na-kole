...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.name'
        db.alter_column(u'dpnk_competition', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=160))

    def backwards(self, orm):

        # Changing field 'Competition.name'
        db.alter_column(u'dpnk_competition', 'name', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
