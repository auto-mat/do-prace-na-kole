...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dpnk_userprofile', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['dpnk.Team']))

    def backwards(self, orm):

        # Changing field 'UserProfile.team'
        db.alter_column(u'dpnk_userprofile', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dpnk.Team']))
