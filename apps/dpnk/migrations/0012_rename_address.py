...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('dpnk_subsidiary', 'street', 'address_street')
        db.rename_column('dpnk_subsidiary', 'street_number', 'address_street_number')
        db.rename_column('dpnk_subsidiary', 'recipient', 'address_recipient')
        db.rename_column('dpnk_subsidiary', 'district', 'address_district')
        db.rename_column('dpnk_subsidiary', 'PSC', 'address_psc')
        db.rename_column('dpnk_subsidiary', 'street', 'address_street')
    ...
    models = {
        ...
        'dpnk.subsidiary': {
            ...
            'address_psc': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'address_district': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'address_recipient': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'address_street': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'address_street_number': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        'dpnk.team': {
