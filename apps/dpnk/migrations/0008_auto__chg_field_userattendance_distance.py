...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAttendance.distance'
        db.alter_column(u'dpnk_userattendance', 'distance', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserAttendance.distance'
        db.alter_column(u'dpnk_userattendance', 'distance', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'dpnk.userattendance': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']"}),
            'distance': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
