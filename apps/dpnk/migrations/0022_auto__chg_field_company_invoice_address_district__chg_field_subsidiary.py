...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.invoice_address_district'
        db.alter_column('dpnk_company', 'invoice_address_district', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Subsidiary.address_district'
        db.alter_column('dpnk_subsidiary', 'address_district', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Company.invoice_address_district'
        db.alter_column('dpnk_company', 'invoice_address_district', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Subsidiary.address_district'
        db.alter_column('dpnk_subsidiary', 'address_district', self.gf('django.db.models.fields.CharField')(max_length=50))
