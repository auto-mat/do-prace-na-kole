...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user_attendance in orm['dpnk.UserAttendance'].objects.all():
            name = dict(TSHIRTSIZE)[user_attendance.t_shirt_size]
            if user_attendance.t_shirt_size == '':
                t_shirt_size = None
            else:
                t_shirt_size, created = orm['dpnk.TShirtSize'].objects.get_or_create(campaign=user_attendance.campaign, name=name)
            user_attendance.t_shirt_size_id = t_shirt_size
