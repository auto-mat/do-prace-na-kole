...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dpnk_companyadmin', (
            ...
            ('company_admin_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('administrated_company', self.gf('django.db.models.fields.related.OneToOneField')(related_name='company_admin', unique=True, to=orm['dpnk.Company'])),
        ))
        db.send_create_signal(u'dpnk', ['CompanyAdmin'])

        # Deleting field 'Company.company_admin'
        db.delete_column(u'dpnk_company', 'company_admin_id')

        # Deleting field 'UserProfile.motivation_company_admin'
        db.delete_column(u'dpnk_userprofile', 'motivation_company_admin')

        # Deleting field 'UserProfile.company_admin_unapproved'
        db.delete_column(u'dpnk_userprofile', 'company_admin_unapproved')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Company.company_admin'
        db.add_column(u'dpnk_company', 'company_admin',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='administrated_company', unique=True, null=True, to=orm['dpnk.UserProfile'], blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.motivation_company_admin'
        db.add_column(u'dpnk_userprofile', 'motivation_company_admin',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=5000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.company_admin_unapproved'
        db.add_column(u'dpnk_userprofile', 'company_admin_unapproved',
    ...
    models = {
        ...
        u'dpnk.companyadmin': {
            ...
            'company_admin_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dpnk.payment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['dpnk.UserProfile']", 'null': 'True', 'blank': 'True'})
        },
        u'dpnk.question': {
        ...
        u'dpnk.userprofile': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'to': u"orm['dpnk.Team']"}),
            'telephone': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
