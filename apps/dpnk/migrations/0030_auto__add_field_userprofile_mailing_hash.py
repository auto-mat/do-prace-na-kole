...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.mailing_hash'
        db.add_column(u'dpnk_userprofile', 'mailing_hash',
                      self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.mailing_hash'
        db.delete_column(u'dpnk_userprofile', 'mailing_hash')
