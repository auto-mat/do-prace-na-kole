...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionResult.company'
        db.add_column(u'dpnk_competitionresult', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='company_results', null=True, blank=True, to=orm['dpnk.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionResult.company'
        db.delete_column(u'dpnk_competitionresult', 'company_id')
