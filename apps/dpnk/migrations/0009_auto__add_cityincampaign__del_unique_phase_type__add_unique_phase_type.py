...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CompanyAdmin', fields ['administrated_company']
        db.delete_unique(u'dpnk_companyadmin', ['administrated_company_id'])

        # Removing unique constraint on 'CompanyAdmin', fields ['user']
        db.delete_unique(u'dpnk_companyadmin', ['user_id'])

        # Removing unique constraint on 'Phase', fields ['type']
        db.delete_unique(u'dpnk_phase', ['type'])

        # Adding model 'CityInCampaign'
        db.create_table(u'dpnk_cityincampaign', (
        ...
        db.send_create_signal(u'dpnk', ['CityInCampaign'])

        # Adding unique constraint on 'CityInCampaign', fields ['city', 'campaign']
        db.create_unique(u'dpnk_cityincampaign', ['city_id', 'campaign_id'])

        # Adding unique constraint on 'Phase', fields ['type', 'campaign']
        db.create_unique(u'dpnk_phase', ['type', 'campaign_id'])

        # Deleting field 'City.admission_fee'
        db.delete_column(u'dpnk_city', 'admission_fee')

        # Adding field 'Subsidiary.city_in_campaign'
        db.add_column(u'dpnk_subsidiary', 'city_in_campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.CityInCampaign'], null=True),
                      keep_default=False)

        # Deleting field 'CompanyAdmin.mailing_id'
        db.delete_column(u'dpnk_companyadmin', 'mailing_id')

        # Deleting field 'CompanyAdmin.telephone'
        db.delete_column(u'dpnk_companyadmin', 'telephone')

        # Adding field 'CompanyAdmin.campaign'
        db.add_column(u'dpnk_companyadmin', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dpnk.Campaign']),
                      keep_default=False)


        # Changing field 'CompanyAdmin.user'
        db.alter_column(u'dpnk_companyadmin', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding unique constraint on 'CompanyAdmin', fields ['user', 'campaign']
        db.create_unique(u'dpnk_companyadmin', ['user_id', 'campaign_id'])

        # Adding unique constraint on 'CompanyAdmin', fields ['administrated_company', 'campaign']
        db.create_unique(u'dpnk_companyadmin', ['administrated_company_id', 'campaign_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyAdmin', fields ['administrated_company', 'campaign']
        db.delete_unique(u'dpnk_companyadmin', ['administrated_company_id', 'campaign_id'])

        # Removing unique constraint on 'CompanyAdmin', fields ['user', 'campaign']
        db.delete_unique(u'dpnk_companyadmin', ['user_id', 'campaign_id'])

        # Removing unique constraint on 'Phase', fields ['type', 'campaign']
        db.delete_unique(u'dpnk_phase', ['type', 'campaign_id'])

        # Removing unique constraint on 'CityInCampaign', fields ['city', 'campaign']
        db.delete_unique(u'dpnk_cityincampaign', ['city_id', 'campaign_id'])

        # Deleting model 'CityInCampaign'
        db.delete_table(u'dpnk_cityincampaign')

        # Adding unique constraint on 'Phase', fields ['type']
        db.create_unique(u'dpnk_phase', ['type'])

        # Adding field 'City.admission_fee'
        db.add_column(u'dpnk_city', 'admission_fee',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=160),
                      keep_default=False)

        # Deleting field 'Subsidiary.city_in_campaign'
        db.delete_column(u'dpnk_subsidiary', 'city_in_campaign_id')
        ...
        # Adding field 'CompanyAdmin.telephone'
        db.add_column(u'dpnk_companyadmin', 'telephone',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompanyAdmin.campaign'
        db.delete_column(u'dpnk_companyadmin', 'campaign_id')


        # Changing field 'CompanyAdmin.user'
        db.alter_column(u'dpnk_companyadmin', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'CompanyAdmin', fields ['user']
        db.create_unique(u'dpnk_companyadmin', ['user_id'])

        # Adding unique constraint on 'CompanyAdmin', fields ['administrated_company']
        db.create_unique(u'dpnk_companyadmin', ['administrated_company_id'])
    ...
    models = {
        ...
        u'dpnk.cityincampaign': {
            'Meta': {'unique_together': "(('city', 'campaign'),)", 'object_name': 'CityInCampaign'},
        ...
        u'dpnk.subsidiary': {
            ...
            'address_street_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.City']"}),
            'city_in_campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.CityInCampaign']", 'null': 'True'}),
        ...
        u'dpnk.userattendance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            't_shirt_size': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16', 'blank': 'True'}),
