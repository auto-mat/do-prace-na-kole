...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.user'
        db.alter_column(u'dpnk_trip', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['dpnk.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Trip.user'
        db.alter_column(u'dpnk_trip', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dpnk.UserProfile']))
