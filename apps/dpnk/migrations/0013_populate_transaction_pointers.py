...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for child in orm['dpnk.Payment'].objects.all():
          # in which we create the parent:
          parent = orm['dpnk.Transaction']()
          parent.user_attendance = child.user_attendance
          parent.status = child.status
          parent.created = child.created
          parent.realized = child.realized
          parent.polymorphic_ctype = orm['contenttypes.ContentType'].objects.get(model="payment")
          parent.save()
          child.transaction_ptr = parent.pk
          child.save()
    ...
    def backwards(self, orm):
        ...
        for child in orm['dpnk.Payment'].objects.all():
          # in which we create the parent:
          parent = orm['dpnk.Transaction']()
          child.user_attendance = child.user_attendance
          child.status = parent.status
          child.created = parent.created
          child.realized = parent.realized
          child.save()
          parent.transaction_ptr = child.pk
          parent.save()
