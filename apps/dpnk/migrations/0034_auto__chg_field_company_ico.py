...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.ico'
        db.alter_column(u'dpnk_company', 'ico', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Company.ico'
        db.alter_column(u'dpnk_company', 'ico', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
