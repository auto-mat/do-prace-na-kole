...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserAttendance.t_shirt_size'
        db.delete_column(u'dpnk_userattendance', 't_shirt_size')

        db.rename_column(u'dpnk_userattendance', 't_shirt_size_id_id', 't_shirt_size_id')


    def backwards(self, orm):
        # Adding field 'UserAttendance.t_shirt_size'
        db.add_column(u'dpnk_userattendance', 't_shirt_size',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        db.rename_column(u'dpnk_userattendance', 't_shirt_size_id', 't_shirt_size_id_id')
    ...
    models = {
        ...
        u'dpnk.tshirtsize': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name', 'campaign'),)", 'object_name': 'TShirtSize'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
