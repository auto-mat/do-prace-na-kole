...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'dpnk_city_city_admins'))

        # Adding M2M table for field administrated_cities on 'UserProfile'
        m2m_table_name = db.shorten_name(u'dpnk_userprofile_administrated_cities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'dpnk.userprofile'], null=False)),
            ('cityincampaign', models.ForeignKey(orm[u'dpnk.cityincampaign'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'cityincampaign_id'])


    def backwards(self, orm):
        # Adding M2M table for field city_admins on 'City'
        m2m_table_name = db.shorten_name(u'dpnk_city_city_admins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('city', models.ForeignKey(orm[u'dpnk.city'], null=False)),
            ('userprofile', models.ForeignKey(orm[u'dpnk.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['city_id', 'userprofile_id'])

        # Removing M2M table for field administrated_cities on 'UserProfile'
        db.delete_table(db.shorten_name(u'dpnk_userprofile_administrated_cities'))
