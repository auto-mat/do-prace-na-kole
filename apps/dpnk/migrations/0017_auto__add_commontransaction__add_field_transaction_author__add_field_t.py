...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommonTransaction'
        db.create_table(u'dpnk_commontransaction', (
        ...
        db.send_create_signal(u'dpnk', ['CommonTransaction'])

        # Adding field 'Transaction.author'
        db.add_column(u'dpnk_transaction', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'transakce_create', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Transaction.updated_by'
        db.add_column(u'dpnk_transaction', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'transakce_update', null=True, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Company.address_recipient'
        db.alter_column(u'dpnk_company', 'address_recipient', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Subsidiary.address_recipient'
        db.alter_column(u'dpnk_subsidiary', 'address_recipient', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting model 'CommonTransaction'
        db.delete_table(u'dpnk_commontransaction')

        # Deleting field 'Transaction.author'
        db.delete_column(u'dpnk_transaction', 'author_id')

        # Deleting field 'Transaction.updated_by'
        db.delete_column(u'dpnk_transaction', 'updated_by_id')


        # Changing field 'Company.address_recipient'
        db.alter_column(u'dpnk_company', 'address_recipient', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Subsidiary.address_recipient'
        db.alter_column(u'dpnk_subsidiary', 'address_recipient', self.gf('django.db.models.fields.CharField')(max_length=50))
