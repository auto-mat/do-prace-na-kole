...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TShirtSize.t_shirt_preview'
        db.add_column(u'dpnk_tshirtsize', 't_shirt_preview',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TShirtSize.t_shirt_preview'
        db.delete_column(u'dpnk_tshirtsize', 't_shirt_preview')
