...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.campaign'
        db.add_column(u'dpnk_team', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.Campaign'], null=True),
                      keep_default=False)

        # Adding field 'Subsidiary.city'
        db.add_column(u'dpnk_subsidiary', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.City'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.campaign'
        db.delete_column(u'dpnk_team', 'campaign_id')

        # Deleting field 'Subsidiary.city'
        db.delete_column(u'dpnk_subsidiary', 'city_id')
    ...
    models = {
        ...
        u'dpnk.subsidiary': {
            ...
            'address_street': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'address_street_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.City']", 'null': 'True'}),
        ...
        u'dpnk.team': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']", 'null': 'True'}),
