...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dpnk_payment', 'order_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Payment.session_id'
        db.alter_column('dpnk_payment', 'session_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Payment.user'
        db.alter_column('dpnk_payment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.UserProfile'], null=True))
        # Adding field 'UserProfile.language'
        db.add_column('dpnk_userprofile', 'language',
                      self.gf('django.db.models.fields.CharField')(default='cs', max_length=16),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Payment.order_id'
        db.alter_column('dpnk_payment', 'order_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Payment.session_id'
        db.alter_column('dpnk_payment', 'session_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Payment.user'
        db.alter_column('dpnk_payment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['dpnk.UserProfile']))
        # Deleting field 'UserProfile.language'
        db.delete_column('dpnk_userprofile', 'language')
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'0DP8GS20LPWYTL1MQQN4IBQQVJGQF7'", 'unique': 'True', 'max_length': '100'}),
