...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAttendance.team'
        db.alter_column(u'dpnk_userattendance', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dpnk.Team']))

    def backwards(self, orm):

        # Changing field 'UserAttendance.team'
        db.alter_column(u'dpnk_userattendance', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dpnk.Team']))
