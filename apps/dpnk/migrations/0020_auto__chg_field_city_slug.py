...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dpnk_city', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'City.slug'
        db.alter_column('dpnk_city', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'6DPJ6JPJESYFSLTZ1004EKENGCELTW'", 'unique': 'True', 'max_length': '100'}),
