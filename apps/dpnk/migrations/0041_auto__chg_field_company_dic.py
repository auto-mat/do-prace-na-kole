...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.dic'
        db.alter_column(u'dpnk_company', 'dic', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Company.dic'
        db.alter_column(u'dpnk_company', 'dic', self.gf('django.db.models.fields.CharField')(max_length=10))
