...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.trip_plus_distance'
        db.add_column(u'dpnk_campaign', 'trip_plus_distance',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.trip_plus_distance'
        db.delete_column(u'dpnk_campaign', 'trip_plus_distance')
    ...
    models = {
        ...
        u'dpnk.competition': {
            'Meta': {'ordering': "('type', 'name')", 'object_name': 'Competition'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']"}),
