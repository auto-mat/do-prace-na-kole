...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyAdmin.note'
        db.add_column(u'dpnk_companyadmin', 'note',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True),
                      keep_default=False)

        # Adding field 'CompanyAdmin.can_confirm_payments'
        db.add_column(u'dpnk_companyadmin', 'can_confirm_payments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyAdmin.note'
        db.delete_column(u'dpnk_companyadmin', 'note')

        # Deleting field 'CompanyAdmin.can_confirm_payments'
        db.delete_column(u'dpnk_companyadmin', 'can_confirm_payments')
    ...
    models = {
        ...
        u'dpnk.companyadmin': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True'}),
        ...
        u'dpnk.deliverybatch': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': u"orm['dpnk.Campaign']"}),
