...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('dpnk_city', 'slug')
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'Z4GZ4SFD67NI7SG8FXIR5FRYT2F8ET'", 'unique': 'True', 'max_length': '100'}),
