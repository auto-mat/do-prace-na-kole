...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.mailing_id'
        db.add_column('dpnk_userprofile', 'mailing_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.mailing_id'
        db.delete_column('dpnk_userprofile', 'mailing_id')
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'MVXPW4UWIIQMZTT533JCZZBACJTUE7'", 'unique': 'True', 'max_length': '100'}),
