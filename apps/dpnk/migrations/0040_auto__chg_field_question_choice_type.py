...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.choice_type'
        db.alter_column(u'dpnk_question', 'choice_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.ChoiceType'], null=True))

        # Changing field 'Question.text'
        db.alter_column(u'dpnk_question', 'text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Question.choice_type'
        db.alter_column(u'dpnk_question', 'choice_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dpnk.ChoiceType']))

        # Changing field 'Question.text'
        db.alter_column(u'dpnk_question', 'text', self.gf('django.db.models.fields.TextField')(default=None, max_length=500))
