...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveryBatch'
        db.create_table(u'dpnk_deliverybatch', (
        ...
        db.send_create_signal(u'dpnk', ['DeliveryBatch'])

        # Adding field 'PackageTransaction.t_shirt_size'
        db.add_column(u'dpnk_packagetransaction', 't_shirt_size',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.TShirtSize'], null=True),
                      keep_default=False)

        # Adding field 'PackageTransaction.tracking_number'
        db.add_column(u'dpnk_packagetransaction', 'tracking_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, unique=True),
                      keep_default=False)

        # Adding field 'PackageTransaction.delivery_batch'
        db.add_column(u'dpnk_packagetransaction', 'delivery_batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dpnk.DeliveryBatch']),
                      keep_default=False)

        # Adding field 'Campaign.tracking_number_first'
        db.add_column(u'dpnk_campaign', 'tracking_number_first',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.tracking_number_last'
        db.add_column(u'dpnk_campaign', 'tracking_number_last',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'dpnk_deliverybatch')

        # Deleting field 'PackageTransaction.t_shirt_size'
        db.delete_column(u'dpnk_packagetransaction', 't_shirt_size_id')

        # Deleting field 'PackageTransaction.tracking_number'
        db.delete_column(u'dpnk_packagetransaction', 'tracking_number')

        # Deleting field 'PackageTransaction.delivery_batch'
        db.delete_column(u'dpnk_packagetransaction', 'delivery_batch_id')

        # Deleting field 'Campaign.tracking_number_first'
        db.delete_column(u'dpnk_campaign', 'tracking_number_first')
