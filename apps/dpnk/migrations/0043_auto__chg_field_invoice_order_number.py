...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.order_number'
        db.alter_column(u'dpnk_invoice', 'order_number', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.order_number'
        db.alter_column(u'dpnk_invoice', 'order_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
