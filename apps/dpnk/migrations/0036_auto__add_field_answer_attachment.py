...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.attachment'
        db.add_column(u'dpnk_answer', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=600),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.attachment'
        db.delete_column(u'dpnk_answer', 'attachment')
