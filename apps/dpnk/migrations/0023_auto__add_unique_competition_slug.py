...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('dpnk_competition', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Competition', fields ['slug']
        db.delete_unique('dpnk_competition', ['slug'])
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'NNB7CIXDXE0E60D2MVWM4SQP82IGWB'", 'unique': 'True', 'max_length': '100'}),
