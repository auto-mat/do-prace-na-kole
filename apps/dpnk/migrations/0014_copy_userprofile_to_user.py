...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for userprofile in orm['dpnk.UserProfile'].objects.all():
            ...
            user.last_name = userprofile.surname
            user.first_name = userprofile.firstname
            user.is_active = userprofile.active
            user.save()
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'RBPA9QDB8NC71PYMIG15S6QAMY7U2M'", 'unique': 'True', 'max_length': '100'}),
