...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.email_footer'
        db.add_column(u'dpnk_campaign', 'email_footer',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=5000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.email_footer'
        db.delete_column(u'dpnk_campaign', 'email_footer')
