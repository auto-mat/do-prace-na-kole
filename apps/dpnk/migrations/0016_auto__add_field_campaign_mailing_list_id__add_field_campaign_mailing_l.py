...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.mailing_list_id'
        db.add_column(u'dpnk_campaign', 'mailing_list_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.mailing_list_enabled'
        db.add_column(u'dpnk_campaign', 'mailing_list_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.mailing_list_id'
        db.delete_column(u'dpnk_campaign', 'mailing_list_id')

        # Deleting field 'Campaign.mailing_list_enabled'
        db.delete_column(u'dpnk_campaign', 'mailing_list_enabled')
