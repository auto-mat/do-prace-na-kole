...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subsidiary.city_in_campaign'
        db.alter_column(u'dpnk_subsidiary', 'city_in_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dpnk.CityInCampaign']))

    def backwards(self, orm):
        # Adding field 'Subsidiary.city'
        db.add_column(u'dpnk_subsidiary', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dpnk.City']),
                      keep_default=False)


        # Changing field 'Subsidiary.city_in_campaign'
        db.alter_column(u'dpnk_subsidiary', 'city_in_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.CityInCampaign'], null=True))
