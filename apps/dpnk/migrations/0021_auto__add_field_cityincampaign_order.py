...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TShirtSize.order'
        db.add_column(u'dpnk_tshirtsize', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TShirtSize.order'
        db.delete_column(u'dpnk_tshirtsize', 'order')
    ...
    models = {
        ...
        u'dpnk.tshirtsize': {
            'Meta': {'ordering': "['campaign', 'order']", 'unique_together': "(('name', 'campaign'),)", 'object_name': 'TShirtSize'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
