...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dpnk_invoice', (
            ...
            ('exposure_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True)),
            ('taxable_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True)),
        ...
        # Adding field 'Campaign.invoice_sequence_number_first'
        db.add_column(u'dpnk_campaign', 'invoice_sequence_number_first',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.invoice_sequence_number_last'
        db.add_column(u'dpnk_campaign', 'invoice_sequence_number_last',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Campaign.invoice_sequence_number_first'
        db.delete_column(u'dpnk_campaign', 'invoice_sequence_number_first')
