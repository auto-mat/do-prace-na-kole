...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyAdmin.telephone'
        db.alter_column(u'dpnk_companyadmin', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'CompanyAdmin.administrated_company'
        db.alter_column(u'dpnk_companyadmin', 'administrated_company_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dpnk.Company']))

    def backwards(self, orm):

        # Changing field 'CompanyAdmin.telephone'
        db.alter_column(u'dpnk_companyadmin', 'telephone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
