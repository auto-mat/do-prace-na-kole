...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CompetitionResult', fields ['result']
        db.create_index(u'dpnk_competitionresult', ['result'])

        # Adding index on 'Team', fields ['member_count']
        db.create_index(u'dpnk_team', ['member_count'])


    def backwards(self, orm):
        # Removing index on 'Team', fields ['member_count']
        db.delete_index(u'dpnk_team', ['member_count'])

        # Removing index on 'CompetitionResult', fields ['result']
        db.delete_index(u'dpnk_competitionresult', ['result'])
