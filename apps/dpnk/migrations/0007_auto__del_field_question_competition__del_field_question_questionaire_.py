...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ChoiceType', fields ['name']
        db.create_unique('dpnk_choicetype', ['name'])

        # Deleting field 'Choice.question'
        db.delete_column('dpnk_choice', 'question_id')


    def backwards(self, orm):
        # Removing unique constraint on 'ChoiceType', fields ['name']
        db.delete_unique('dpnk_choicetype', ['name'])
        ...
        db.add_column('dpnk_choice', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['dpnk.Question']),
                      keep_default=False)
