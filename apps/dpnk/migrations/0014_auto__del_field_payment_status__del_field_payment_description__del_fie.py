...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserActionTransaction'
        db.create_table(u'dpnk_useractiontransaction', (
            (u'transaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dpnk.Transaction'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'dpnk', ['UserActionTransaction'])

        # Adding model 'PackageTransaction'
        db.create_table(u'dpnk_packagetransaction', (
            (u'transaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dpnk.Transaction'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'dpnk', ['PackageTransaction'])

        # Deleting field 'Payment.status'
        db.delete_column(u'dpnk_payment', 'status')

        # Deleting field 'Payment.description'
        db.delete_column(u'dpnk_payment', 'description')

        # Deleting field 'Payment.user_attendance'
        db.delete_column(u'dpnk_payment', 'user_attendance_id')

        # Deleting field 'Payment.id'
        db.delete_column(u'dpnk_payment', u'id')

        # Deleting field 'Payment.realized'
        db.delete_column(u'dpnk_payment', 'realized')

        # Deleting field 'Payment.created'
        db.delete_column(u'dpnk_payment', 'created')


        # Renaming column for 'Payment.transaction_ptr' to match new field type.
        db.rename_column(u'dpnk_payment', 'transaction_ptr', u'transaction_ptr_id')
        # Changing field 'Payment.transaction_ptr'
        db.alter_column(u'dpnk_payment', u'transaction_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['dpnk.Transaction'], unique=True, primary_key=True))
        # Adding index on 'Payment', fields [u'transaction_ptr']
        db.create_index(u'dpnk_payment', [u'transaction_ptr_id'])

        # Adding unique constraint on 'Payment', fields [u'transaction_ptr']
        db.create_unique(u'dpnk_payment', [u'transaction_ptr_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Payment', fields [u'transaction_ptr']
        db.delete_unique(u'dpnk_payment', [u'transaction_ptr_id'])

        # Removing index on 'Payment', fields [u'transaction_ptr']
        db.delete_index(u'dpnk_payment', [u'transaction_ptr_id'])

        # Deleting model 'UserActionTransaction'
        db.delete_table(u'dpnk_useractiontransaction')

        # Deleting model 'PackageTransaction'
        db.delete_table(u'dpnk_packagetransaction')

        # Adding field 'Payment.status'
        db.add_column(u'dpnk_payment', 'status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payment.description'
        db.add_column(u'dpnk_payment', 'description',
        ...
        db.add_column(u'dpnk_payment', 'user_attendance',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='payments', null=True, to=orm['dpnk.UserAttendance'], blank=True),
                      keep_default=False)

        # Adding field 'Payment.id'
        db.add_column(u'dpnk_payment', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)

        # Adding field 'Payment.realized'
        db.add_column(u'dpnk_payment', 'realized',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payment.created'
        db.add_column(u'dpnk_payment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Renaming column for 'Payment.transaction_ptr' to match new field type.
        db.rename_column(u'dpnk_payment', u'transaction_ptr_id', 'transaction_ptr')
        # Changing field 'Payment.transaction_ptr'
        db.alter_column(u'dpnk_payment', 'transaction_ptr', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'dpnk.answer': {
            'Meta': {'ordering': "('user_attendance__team__subsidiary__city_in_campaign__city', 'pk')", 'unique_together': "(('user_attendance', 'question'),)", 'object_name': 'Answer'},
        ...
        u'dpnk.subsidiary': {
            ...
            'address_street': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'address_street_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
            'city_in_campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.CityInCampaign']"}),
        ...
        u'dpnk.transaction': {
            ...
            'status': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '50'}),
            'user_attendance': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['dpnk.UserAttendance']", 'null': 'True'})
        },
        u'dpnk.trip': {
