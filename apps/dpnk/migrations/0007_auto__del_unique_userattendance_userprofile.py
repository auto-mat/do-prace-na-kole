...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserAttendance', fields ['userprofile']
        db.delete_unique(u'dpnk_userattendance', ['userprofile_id'])

        # Adding unique constraint on 'UserAttendance', fields ['userprofile', 'campaign']
        db.create_unique(u'dpnk_userattendance', ['userprofile_id', 'campaign_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAttendance', fields ['userprofile', 'campaign']
        db.delete_unique(u'dpnk_userattendance', ['userprofile_id', 'campaign_id'])

        # Adding unique constraint on 'UserAttendance', fields ['userprofile']
        db.create_unique(u'dpnk_userattendance', ['userprofile_id'])
