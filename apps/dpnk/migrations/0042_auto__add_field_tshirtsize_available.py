...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TShirtSize.available'
        db.add_column(u'dpnk_tshirtsize', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TShirtSize.available'
        db.delete_column(u'dpnk_tshirtsize', 'available')
