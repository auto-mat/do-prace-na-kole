...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dpnk_tshirtsize', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.Campaign'])),
        ))
        db.send_create_signal(u'dpnk', ['TShirtSize'])

        # Adding unique constraint on 'TShirtSize', fields ['name', 'campaign']
        db.create_unique(u'dpnk_tshirtsize', ['name', 'campaign_id'])

        # Adding field 'UserAttendance.t_shirt_size_id'
        db.add_column(u'dpnk_userattendance', 't_shirt_size_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnk.TShirtSize'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'TShirtSize', fields ['name', 'campaign']
        db.delete_unique(u'dpnk_tshirtsize', ['name', 'campaign_id'])

        # Deleting model 'TShirtSize'
        db.delete_table(u'dpnk_tshirtsize')

        # Deleting field 'UserAttendance.t_shirt_size_id'
        db.delete_column(u'dpnk_userattendance', 't_shirt_size_id_id')
    ...
    models = {
        ...
        u'dpnk.tshirtsize': {
            'Meta': {'unique_together': "(('name', 'campaign'),)", 'object_name': 'TShirtSize'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dpnk.userattendance': {
            ...
            't_shirt_size_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dpnk.TShirtSize']", 'null': 'True'}),
