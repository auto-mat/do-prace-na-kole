...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dpnk_transaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_dpnk.transaction_set', null=True, to=orm['contenttypes.ContentType'])),
            ('status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=50)),
            ('user_attendance', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='transactions', null=True, blank=True, to=orm['dpnk.UserAttendance'])),
        ...
        db.send_create_signal(u'dpnk', ['Transaction'])

        # Adding field 'Payment.transaction_ptr'
        db.add_column(u'dpnk_payment', 'transaction_ptr',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'dpnk_transaction')

        # Deleting field 'Payment.transaction_ptr'
        db.delete_column(u'dpnk_payment', 'transaction_ptr')
    ...
    models = {
        ...
        u'dpnk.payment': {
            ...
            'transaction_ptr': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        u'dpnk.transaction': {
            ...
            'user_attendance': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'transactions'", 'null': 'True', 'blank': 'True', 'to': u"orm['dpnk.UserAttendance']"})
        },
        u'dpnk.trip': {
