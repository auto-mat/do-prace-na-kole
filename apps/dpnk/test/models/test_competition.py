    ...
    def test_single_frequency_competition(self):
        ...
        expected_columns = [
            ...
            (
                "result_divident",
                "get_result_divident",
                "Po&shy;čet za&shy;po&shy;čí&shy;ta&shy;ných jí&shy;zd",
            ),
            (
                "result_divisor",
                "get_result_divisor",
                "Cel&shy;ko&shy;vý po&shy;čet cest",
            ),
            ("competitor", "user_attendance", "Sou&shy;tě&shy;ží&shy;cí"),
            ("team", "get_team_name", "Tým"),
            ("company", "get_company", "Spo&shy;leč&shy;nost"),
    ...
    def test_team_frequency_competition(self):
        ...
        expected_columns = [
            ...
            (
                "member_count",
                "team__member_count",
                "Po&shy;čet sou&shy;tě&shy;ží&shy;cí&shy;ch v&nbsp;tý&shy;mu",
            ),
    ...
    def test_company_length_competition(self):
        ...
        expected_columns = [
            ...
            (
                "result_value",
                "get_result",
                "Ki&shy;lo&shy;me&shy;trů prů&shy;měr&shy;ně",
            ),
...
class GetResultsIdRankDictTests(TestCase):
    def test_dict(self):
        ...
        self.assertDictEqual(
            competition.get_result_id_rank_dict(results), expected_dict
        )
