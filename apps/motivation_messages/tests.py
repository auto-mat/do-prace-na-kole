...
class MessagesTest(TestCase):
    def setUp(self):
        self.campaign_type1 = mommy.make(
            "CampaignType", name="campaign type 1", slug="ct1"
        )
        self.campaign_type2 = mommy.make(
            "CampaignType", name="campaign type 2", slug="ct2"
        )
    ...
    def test_get_all_messages_simple(self):
        ...
        self.assertQuerysetEqual(
            MotivationMessage._get_all_messages(self.user_attendance),
            [message],
    ...
    def test_get_all_messages_date(self):
        ...
        messages = MotivationMessage._get_all_messages(self.user_attendance).order_by(
            "id"
        )
        self.assertQuerysetEqual(
            messages, (message1, message2, message3), transform=lambda x: x
        )

    def test_get_all_messages_percentage(self):
        message1 = mommy.make(
            "MotivationMessage", message="message 1", frequency_min=65, frequency_max=65
        )
        message2 = mommy.make(
            "MotivationMessage", message="message 2", frequency_min=60
        )
        message3 = mommy.make(
            "MotivationMessage", message="message 3", frequency_max=65
        )
        mommy.make(
            "MotivationMessage", message="message 4", frequency_min=66, frequency_max=66
        )
        mommy.make(
            "MotivationMessage", message="message 5", frequency_min=64, frequency_max=64
        )
    ...
    def test_get_all_messages_day(self):
        message1 = mommy.make(
            "MotivationMessage", message="message1", day_from=2, day_to=2
        )
    ...
    def test_get_all_messages_rank(self):
        message1 = mommy.make(
            "MotivationMessage", message="message1", team_rank_from=2, team_rank_to=2
        )
        ...
        mommy.make(
            "MotivationMessage", message="message4", team_rank_from=1, team_rank_to=1
        )
        mommy.make(
            "MotivationMessage", message="message5", team_rank_from=3, team_rank_to=3
        )
    ...
    def test_get_all_messages_campaign_types(self):
        message1 = mommy.make(
            "MotivationMessage",
            message="message1",
            campaign_types=[self.campaign_type1, self.campaign_type2],
        )
        mommy.make(
            "MotivationMessage",
            message="message2",
            campaign_types=[self.campaign_type2],
        )
        message3 = mommy.make(
            "MotivationMessage", message="message3", campaign_types=[]
        )
        messages = MotivationMessage._get_all_messages(self.user_attendance).order_by(
            "id"
        )
