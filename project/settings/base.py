...
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.getenv("DPNK_DATA_UPLOAD_MAX_MEMORY_SIZE", 2621440))
FILE_UPLOAD_MAX_MEMORY_SIZE = int(os.getenv("DPNK_FILE_UPLOAD_MAX_MEMORY_SIZE", 2621440))
