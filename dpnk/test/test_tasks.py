...
class TestSendUnfilledRidesNotification(TestCase):
    ...
    def test_notification(self):
        ...
        self.assertEqual(str(mail.outbox[0].subject), "[Testing campaign 2019] Poslední šance doplnit jízdy")
...
class TestSendUnpaidInvoiceNotification(TestCase):
    ...
    def test_notification(self):
        ...
        msg = mail.outbox[0]
        self.assertEqual(msg.recipients(), ['test@test.cz'])
        self.assertEqual(str(mail.outbox[0].subject), "[Testing campaign 2019] Nezaplacená faktura")
    ...
    def test_english_notification(self):
        ...
        msg = mail.outbox[0]
        self.assertEqual(msg.recipients(), ['test@test.cz'])
        self.assertEqual(str(mail.outbox[0].subject), "[Testing campaign 2019] Unpaid Invoice")
