...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ChoiceType', fields ['name', 'competition']
        db.create_unique('dpnk_choicetype', ['name', 'competition_id'])


        # Changing field 'Team.coordinator'
        db.alter_column('dpnk_team', 'coordinator_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, unique=True, to=orm['dpnk.UserProfile']))

        # Changing field 'Team.invitation_token'
        db.alter_column('dpnk_team', 'invitation_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):
        # Removing unique constraint on 'ChoiceType', fields ['name', 'competition']
        db.delete_unique('dpnk_choicetype', ['name', 'competition_id'])
        ...
        # Changing field 'Team.invitation_token'
        db.alter_column('dpnk_team', 'invitation_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
    ...
    models = {
        ...
        'dpnk.team': {
            ...
            'coordinator': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'coordinated_team'", 'unique': 'True', 'to': "orm['dpnk.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_token': ('django.db.models.fields.CharField', [], {'default': "'BS01VVYQBA1U3DTMNUM7FYXXVRGHPQ'", 'unique': 'True', 'max_length': '100'}),
