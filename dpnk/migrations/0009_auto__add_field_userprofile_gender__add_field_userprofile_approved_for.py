...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dpnk_userprofile', 'approved_for_team',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Team.password'
        db.delete_column('dpnk_team', 'password')

        # Adding field 'Team.invitation_token'
        db.add_column('dpnk_team', 'invitation_token',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('dpnk_userprofile', 'approved_for_team')

        # Adding field 'Team.password'
        db.add_column('dpnk_team', 'password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Deleting field 'Team.invitation_token'
        db.delete_column('dpnk_team', 'invitation_token')
