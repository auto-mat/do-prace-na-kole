...
file=`curl "http://online.gls-czech.com/ll_getReportClass.php?uid=10424&lng=cz&fileType=CSV&dateFrom=$dateFrom&dateTo=$dateTo&senderID=-1&replist=0-30&gapid=-1" -H "Cookie: PHPSESSID=$sessionID; SRV_ID=01; cookie[userdata][lessersecurity]=1; cookie[userdata][username]=$username; cookie[userdata][password]=$password"`
echo $file
